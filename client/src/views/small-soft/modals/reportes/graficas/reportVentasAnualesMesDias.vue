  ...
  <VCard class="pt-2">
    <VRow no-gutters>
      ...
      >
        ...
        <VCardText class=" d-flex justify-between" style="justify-content: space-between;" >
          <div
            v-for="(report, index) in reportData"
            :key="report.title"
            class="bg-var-theme-background d-flex align-center gap-3 px-3 py-3 rounded"
          >
            <VAvatar
              rounded
              size="25"
      ...
      >
        <VCardItem>
          <VCardTitle>Todas las ventas</VCardTitle>
